...
class Rectangle:
    ...
    def width(self):
        """
        Getter method for retrieving and width of the rectangle.
    ...
    def perimeter(self):
        """
        Calculates and returns the perimter of the rectangle.
    ...
    def __str__(self):
        ...
        Returns:
            str: String representation of the rectangle, with the character(s)
            in print_symbol forming the shape.
        """
        if self.width == 0 or self.height == 0:
            return ""
    ...
    def __repr(self):
        ...
        recreate a new instance of the rectangle using eval().
